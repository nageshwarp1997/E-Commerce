...
export const CatalogueIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export const StaffIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    stroke="currentColor"
    className={className}
...
export const OnlineStoresIcon = ({ className }: { className?: string }) => (
  <svg
    stroke="currentColor"
    fill="none"
    strokeWidth="2"
...
export const ThreeLayerIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    stroke="currentColor"
    fill="currentColor"
